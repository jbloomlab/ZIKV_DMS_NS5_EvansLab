...
```
    ...
    convert: profile 'icc': 'RGB ': RGB color space not permitted on grayscale PNG `results/tile_3/codoncounts/._summary_readsperbc.png' @ warning/png.c/MagickPNGWarningHandler/1746.



![png](dms_tile_3_analysis_files/dms_tile_3_analysis_20_1.png)
...
```
    ...
    convert: profile 'icc': 'RGB ': RGB color space not permitted on grayscale PNG `results/tile_3/codoncounts/._summary_depth.png' @ warning/png.c/MagickPNGWarningHandler/1746.



![png](dms_tile_3_analysis_files/dms_tile_3_analysis_22_1.png)
...
```
    ...
    convert: profile 'icc': 'RGB ': RGB color space not permitted on grayscale PNG `results/tile_3/codoncounts/._summary_mutfreq.png' @ warning/png.c/MagickPNGWarningHandler/1746.



![png](dms_tile_3_analysis_files/dms_tile_3_analysis_24_1.png)
...
```
    ...
    convert: profile 'icc': 'RGB ': RGB color space not permitted on grayscale PNG `results/tile_3/prefs/._summary_prefscorr.png' @ warning/png.c/MagickPNGWarningHandler/1746.



![png](dms_tile_3_analysis_files/dms_tile_3_analysis_46_1.png)
...
![png](dms_tile_3_analysis_files/dms_tile_3_analysis_50_1.png)
...
![png](dms_tile_3_analysis_files/dms_tile_3_analysis_50_3.png)
...
![png](dms_tile_3_analysis_files/dms_tile_3_analysis_56_1.png)
...
![png](dms_tile_3_analysis_files/dms_tile_3_analysis_56_3.png)
